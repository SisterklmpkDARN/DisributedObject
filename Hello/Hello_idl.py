...
Hello._d_echoString = (((omniORB.tcInternal.tv_string,0), ), ((omniORB.tcInternal.tv_string,0), ), None)
...
class _objref_Hello (CORBA.Object):
    ...
    def echoString(self, *args):
        return self._obj.invoke("echoString", _0_HelloApp.Hello._d_echoString, args)
...
class Hello (PortableServer.Servant):
    ...
    _omni_op_d = {"echoString": _0_HelloApp.Hello._d_echoString}
